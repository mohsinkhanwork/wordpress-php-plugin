...
class FrmEntry {
	...
	public static function duplicate( $id ) {
		...
		$new_values['search_engine'] = $values->search_engine;
	...
	public static function sanitize_entry_post( &$values ) {
		$sanitize_method = array(
			...
			'search_engine'   =>  'sanitize_text_field',
		);
	...
	private static function package_entry_data( &$values ) {
		...
		$new_values = array(
			...
			'search_engine'  => self::search_engine( $values ),
	 ...
	 * @return string
	 */
	private static function search_engine( $values ) {
